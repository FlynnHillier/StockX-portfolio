...
function build_private_api_router(mongoose_instance,config){
    ...
    const stock = require(path.join(__dirname,"stock","api_private_stock_RouteHandling"))(mongoose_instance,config)
    const settings = require(path.join(__dirname,"content","api_private_settings"))(mongoose_instance,config)
    ...
    private_api_routeHandler.use("/stock",stock)
    ...
    private_api_routeHandler.use("/settings",settings)
